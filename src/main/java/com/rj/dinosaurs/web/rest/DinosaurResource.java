...
public class DinosaurResource {
    ...
    public ResponseEntity<List<DinosaurDTO>> getAllDinosaurs(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
