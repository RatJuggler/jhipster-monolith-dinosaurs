...
export class CladeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.cladeService
      ...
      .subscribe(
        (res: HttpResponse<IClade[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IClade[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
