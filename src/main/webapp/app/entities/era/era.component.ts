...
export class EraComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.eraService
      ...
      .subscribe(
        (res: HttpResponse<IEra[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IEra[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
